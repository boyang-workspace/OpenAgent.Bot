...
export type BlogTopicLane = "trend" | "comparison" | "evergreen";
export type BlogTopicStatus = "new" | "drafted" | "ignored";
export type BlogDraftStatus = "draft" | "ready" | "pr_created" | "published" | "rejected";
export type BlogPublishStatus = PublishStatus;
export type BlogTopicSourceType = "auto" | "manual";
export type PromptVersionKind = "topic-generation" | "evidence-summarization" | "outline-generation" | "draft-generation" | "reviewer" | "quality-thresholds";
export type TemplateVersionKind = "blog-outline";
export type DebugRunAction = "outline" | "draft" | "review";
export type DebugRunStatus = "completed" | "failed";
...
export type BlogTopic = {
  ...
  date: string;
  lane: BlogTopicLane;
  sourceType: BlogTopicSourceType;
  priority: number;
  title: string;
  angle: string;
...
export type BlogDraft = {
  ...
  generatedContent?: BlogPostContent;
  targetKeyword?: string;
  searchIntent?: string;
  sourceLinks: string[];
  qualityReport: BlogQualityReport;
  reviewReport?: BlogReviewReport;
  prUrl?: string;
  prNumber?: number;
  prBranch?: string;
  commitSha?: string;
