...
const publishedDir = rootDir ? path.join(rootDir, "content/projects/published") : undefined;
const draftsDir = rootDir ? path.join(rootDir, "content/projects/drafts") : undefined;
