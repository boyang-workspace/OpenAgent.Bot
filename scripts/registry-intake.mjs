...
const body = publicationId ? { action: "revision", publicationId } : {
  ...
  corrections: value("--corrections") ? JSON.parse(readFileSync(value("--corrections"), "utf8")) : [],
