  ...
  const index = {
    ...
    resources: resources.map((r) => {
      ...
      return {
        ...
        agent_json_url: detail.agentPacket.machine_readable.agent_json_url,
        ...
        risk_level: detail.agentPacket.risk_level,
        source_confidence: detail.agentPacket.source_confidence,
